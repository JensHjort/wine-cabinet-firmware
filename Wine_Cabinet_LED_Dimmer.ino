...
String buildWebOtaPage() {
  ...
  html += F(".local</strong>"
            ...
            "xhr.onload=function(){"
            "if(xhr.status===200){"
            "startRebootCountdown(10,window.location.href,'msg');"
            "}else{"
            "msg.className='error';"
            ...
            "}"
            "function startRebootCountdown(sec,url,msgId){"
            "var el=document.getElementById(msgId);"
            "el.className='info';el.style.display='block';"
            "var n=sec;"
            "function tick(){"
            "el.textContent='Rebooting — redirecting in '+n+'s...';"
            ...
            ".then(function(){startRebootCountdown(8,'http://'+h+'.local','wifi-msg');})"
            ...
            ".then(function(){startRebootCountdown(10,'http://192.168.4.1','wifi-msg');})"
            ".catch(function(){showMsg('wifi-msg','error','Request failed.');});"
            "}"
            ...
            "startRebootCountdown(10,window.location.href,'update-msg');"
            "}else{"
